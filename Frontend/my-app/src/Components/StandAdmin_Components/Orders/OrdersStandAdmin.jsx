...
import OrderProductsStandAdmin from "./OrderProductsStandAdmin";
...
export default function OrdersStandAdmin() {
                        ...
                        <MDBCardBody>
                          ...
                          <MDBRow style={{ fontSize: "20px" }}>
                            ...
                            <MDBCol
                              ...
                              <div className="mb-1 small" ><OrderProductsStandAdmin key={order._id} {...order} /></div>
                            </MDBCol>
