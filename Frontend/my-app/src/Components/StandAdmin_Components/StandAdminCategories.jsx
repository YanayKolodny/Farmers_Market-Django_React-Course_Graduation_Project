...
import { selectCats, addCategoryAsync, deleteCategoryAsync, setAdminStandCats, selectAdminStandCats } from '../../Slices/categoriesSlice'
...
export default StandAdminCategories