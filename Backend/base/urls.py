...
from .viewsFolder.authViews import MyTokenObtainPairView, check, registration, logOutUser
...
from .viewsFolder.orderViews import newOrder, getAllOrderedProds, getAllOrders, getUserOrders, getStandOrders, getOrderProducts, delOrder
from .viewsFolder.areaViews import addNewArea, getAllAreas, delArea, updArea
from .viewsFolder.profileViews import updUserProfile, getProfile, createProfile
...
urlpatterns = [
    ...
    path('profile/create/<int:id>/', createProfile),
    ...
    path('orders/delorder/<int:id>/', delOrder),
